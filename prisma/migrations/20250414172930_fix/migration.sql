/*
  ...
  - You are about to drop the column `medical_procedure_required_exams_count` on the `medical_procedures` table. All the data in the column will be lost.
  - You are about to drop the column `medical_procedure_specialty_id` on the `medical_procedures` table. All the data in the column will be lost.
